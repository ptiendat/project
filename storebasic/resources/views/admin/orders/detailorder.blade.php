						...
						<div class="bootstrap-table">
							<div class="table-responsive">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="row">
													<div class="col-md-4">
														<img width="100px" src="img/{{$detail->image}}" class="thumbnail">
													</div>
													<div class="col-md-8">
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th>
												<h4 align='right' style="color: brown;">{{$order->total}} VNĐ</h4>
											</th>
								...
								<div class="alert alert-primary" role="alert" align='right'>
									<a name="" id="" class="btn btn-success" href="{{route('order.process',['id'=>$order['id']])}}" role="button">Đã xử lý</a>
								</div>
							</div>
						</div>
