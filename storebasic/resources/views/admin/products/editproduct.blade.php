                             ...
                             <form action="{{route('product.update',['id'=>$product['id']])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="col-md-8">
                                        ...
                                        {!!showCategory($cates,0,'',$product->categories_id)!!}
                                    </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="featured" class="form-control">
                                                <option value="0" @if($product['featured']==0) selected @endif>Không</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="state" class="form-control">
                                                <option value="1" @if($product['state']==1) selected @endif>Còn hàng</option>
